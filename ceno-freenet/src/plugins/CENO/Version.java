...
public class Version implements FredPluginVersioned, FredPluginRealVersioned {
	...
	public static final String CLIENT_VERSION = "1.0.0-alpha";
	public static final int CLIENT_REAL_VERSION = 13;

	public static final String BRIDGE_VERSION = "1.0.0-alpha";
	public static final int BRIDGE_REAL_VERSION = 13;

	public static final String BACKBONE_VERSION = "1.0.0-alpha";
	public static final int BACKBONE_REAL_VERSION = 13;
