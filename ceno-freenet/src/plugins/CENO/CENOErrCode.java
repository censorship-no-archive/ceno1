...
public enum CENOErrCode {
    ...
    LCS_DATABASE_CONNECT_FAILED(2150, CENODocCode.LCS_DATABASE_FAILURE, ErrAction.LOG),
    LCS_DATABASE_OPERATION_FAILED(2151, CENODocCode.LCS_DATABASE_FAILURE, ErrAction.LOG),
